...
from api.views.hope_construction.banner.serializers.main import BannerHCSerializer
from hope_construction.models.banner.main import BannerHCModel


class BannerHCViewSet(DatatableMixin, ModelViewSet):
    ...
    filterset_fields = (field for field in model.MetaDb.fields if field != "banner")
