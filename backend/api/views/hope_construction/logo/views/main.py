...
from api.views.hope_construction.logo.serializers.main import LogoHCSerializer
from hope_construction.models.logo.main import LogoHCModel


class LogoHCViewSet(DatatableMixin, ModelViewSet):
    ...
    filterset_fields = (field for field in model.MetaDb.fields if field != "logoLight" or field != "logoDark")
