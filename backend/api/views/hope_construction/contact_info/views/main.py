...
from api.views.hope_construction.contact_info.serializers.main import ContactInfoHCSerializer
from hope_construction.models.contact_info.main import ContactInfoHCModel


class ContactInfoHCViewSet(DatatableMixin, ModelViewSet):
    ...
    # filterset_fields = (field for field in model.MetaDb.fields if field != "" or field != "" or field != "")
    USER_ID = 0
    ...
    def get_serializer_class(self):
        if self.action in ('list', 'retrieve'):
            return ContactInfoHCSerializer
