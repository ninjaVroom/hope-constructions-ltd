...
from api.views.hope_construction.slider.serializers.main import SliderHCSerializer
from hope_construction.models.slider.main import SliderHCModel


class SliderHCViewSet(DatatableMixin, ModelViewSet):
