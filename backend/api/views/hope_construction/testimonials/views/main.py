...
from api.views.hope_construction.testimonials.serializers.main import TestimonialHCSerializer
from hope_construction.models.testimonials.main import TestimonialHCModel


class TestimonialHCViewSet(DatatableMixin, ModelViewSet):
    ...
    filterset_fields = (field for field in model.MetaDb.fields if field != "image" or field != "video" or field != "quoteAuthorImage")
    ...
    def get_serializer_class(self):
        if self.action in ('list', 'retrieve'):
            return TestimonialHCSerializer
