...
from api.views.hope_construction.services.serializers.main import ServiceHCSerializer
from hope_construction.models.services.main import ServiceHCModel


class ServiceHCViewSet(DatatableMixin, ModelViewSet):
    ...
    filterset_fields = (field for field in model.MetaDb.fields if field != "image" or field != "icon")
