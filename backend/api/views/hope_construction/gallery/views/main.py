...
from api.views.hope_construction.gallery.serializers.main import GalleryHCSerializer
from hope_construction.models.gallery.main import GalleryHCModel


class GalleryHCViewSet(DatatableMixin, ModelViewSet):
    ...
    filterset_fields = (field for field in model.MetaDb.fields if field != "attachment")
